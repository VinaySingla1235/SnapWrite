          ...
          <div className="flex flex-col">
            ...
            <div className="flex px-4 mt-3">
                {cats.map((category,index)=>(
                    <div className="flex justify-center items-center space-x-2 mr-4 bg-gray-200 px-2 py-1 rounded-md" key={index}>
                    <p>{category}</p>
                    <p onClick={()=>{deleteCategory(index)}} className="text-white bg-black rounded-full cursor-pointer p-1 text-sm">
                      <ImCross />
                    </p>
                  </div>
                ))}
